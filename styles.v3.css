...
/* =========================
   WATERMARK XL – vertical, centré, lisible
   ========================= */

/* Neutralisation des anciens watermarks éventuels */
.month .month-watermark {
...
/* Bloc principal du watermark */
.month {
  position: relative;
  overflow: hidden; /* garde un rendu clean */
}
...
/* Le contenu reste toujours au-dessus du watermark */
.month .month-header,
.month .month-head-row,
.month .row {
  position: relative;
  z-index: 1;
}
